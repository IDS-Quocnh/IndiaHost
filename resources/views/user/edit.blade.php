                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('user/edit') }}">
                        ...
                        <div class="form-group">
                            <label for="contry-code" class="col-md-4 control-label">Contry Code</label>
                            <div class="col-md-6">
                                <select name="countryCode" class="form-control" id="countryCode" value="{{$user->country_code}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="tel" placeholder="012345678" class="form-control" name="phone" value="{{$user->phone}}" required>
                            </div>
                        </div>
